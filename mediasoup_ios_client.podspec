Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/NarasimhaDo/mediasoup-ios-client"
  spec.license      = "MIT"
  spec.author       = { "ethand91" => "ethan@maru.jp" }
  spec.platform     = :ios, "9.0"
  spec.source       = { :git => "https://github.com/NarasimhaDo/mediasoup-ios-client", :submodules => true, :tag => "1.5.4" }
